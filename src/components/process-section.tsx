...
const steps = [
  ...
  },
  {
    ...
    description: "Our team builds in focused milestones. You receive regular updates, review points, and clear decisions before the next stage starts.",
    duration: "2-8 Weeks",
  ...
  },
  {
    ...
    description: "We stay available for support, maintenance, and optimization so the delivered system keeps improving after launch.",
    duration: "Ongoing",
    deliverables: ["Priority Support", "Regular Updates", "Performance Optimization"],
  },
]
              ...
              >
                ...
                <div className={`w-full lg:w-[calc(50%-4rem)] ${index % 2 === 0 ? "lg:pr-8" : "lg:pl-8"}`}>
                  <motion.div 
                    ...
                    className="interactive-card animated-border p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all group"
                  >
                    ...
                    <div className="flex items-start gap-4">
                      <div className="hidden lg:flex w-12 h-12 rounded-lg bg-muted group-hover:bg-primary/10 items-center justify-center transition-colors">
