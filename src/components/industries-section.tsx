    ...
    <section id="industries" className="py-24 lg:py-32 bg-muted/30">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            We adapt the same core systems, clear websites, useful automation, and measurable campaigns, to the way your customers actually buy.
          </motion.p>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={viewportOnce} variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {industries.map((industry) => (
            <motion.div
              ...
              className="interactive-card animated-border group p-5 rounded-lg bg-card border border-border hover:border-primary/50 cursor-pointer"
            >
        ...
        >
          <p className="text-muted-foreground mb-4">
            Do not see your industry? We work with businesses of all types.
          </p>
          <a 
            href="#contact" 
